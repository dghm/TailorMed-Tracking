...
function checkRateLimit(ip) {
  ...
  if (minuteCount >= 3) {
    ...
    return {
      ...
      limit: 3,
      waitTime: waitTime,
      message: `Rate limit exceeded. Maximum 3 queries per minute. Please try again in ${waitTime} second(s).`,
    };
  }
  ...
  if (hourCount >= 10) {
    ...
    return {
      ...
      limit: 10,
      waitTime: waitTime,
      message: `Rate limit exceeded. Maximum 10 queries per hour. Please try again in ${waitTime} minute(s).`,
    };
  }
